...
ARCHITECTURE DSMB of p7 is
	...
	signal jed_node10	: std_logic:='0' ; -- i(0)
...
--Attribute PIN_NUMBERS of i(0):SIGNAL is "0010";
...
(not(jed_node1) and not(jed_node2) and not(jed_node3)
 and not(jed_node4) and not(jed_node5) and not(jed_node6)
 and not(jed_node7) and not(jed_node8) and not(jed_node9)
 and (jed_node10)) or
...
jed_sum_22<= ((not(jed_node1) and (jed_node2) and not(jed_node3) and not(jed_node4)
 and not(jed_node5) and not(jed_node6) and not(jed_node7)
 and not(jed_node8) and not(jed_node9) and not(jed_node10)
) or
(not(jed_node1) and not(jed_node2) and not(jed_node3)

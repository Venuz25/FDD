...
--    VHDL File: Binario_Gray.vhd

--    Date: Mon Nov 27 23:56:36 2023
...
ARCHITECTURE DSMB of bg is

	signal jed_node1	: std_logic:='0' ; -- sel
	signal jed_node2	: std_logic:='0' ; -- b(3)
	signal jed_node3	: std_logic:='0' ; -- b(2)
...
--Attribute PIN_NUMBERS of g(1):SIGNAL is "0014";

SIGNAL  jed_oept_15:std_logic:='0';
SIGNAL  jed_sum_15,jed_fb_15:std_logic:='0';
--Attribute PIN_NUMBERS of g(0):SIGNAL is "0015";
...
--Attribute PIN_NUMBERS of g(3):SIGNAL is "0022";

SIGNAL  jed_oept_23:std_logic:='0';
SIGNAL  jed_sum_23,jed_fb_23:std_logic:='0';
--Attribute PIN_NUMBERS of g(2):SIGNAL is "0023";
...
(not(jed_node1) and not(jed_fb_21) and (jed_node4)) or
(not(jed_node1) and (jed_fb_21) and not(jed_node4)));
...
((jed_node1) and not(jed_node2) and not(jed_node3) and not(jed_node4)
 and (jed_node5)) or
(not(jed_node1) and (jed_node5) and not(jed_fb_17)) or
(not(jed_node1) and not(jed_node5) and (jed_fb_17)));

jed_oept_16<=(one);

jed_sum_16<= (((jed_node1) and (jed_fb_16)) or
(not(jed_node1) and (jed_node2)));

jed_oept_17<=(one);

jed_sum_17<= (((jed_node1) and (jed_fb_17)) or
(not(jed_node1) and (jed_node4)));

jed_oept_20<=(one);

jed_sum_20<= (((jed_node1) and (jed_fb_20)));

jed_oept_21<=(one);

jed_sum_21<= (((jed_node1) and (jed_fb_21)) or
(not(jed_node1) and (jed_node3)));

jed_oept_22<=(one);

jed_sum_22<= ((not(jed_node1) and not(jed_node2) and (jed_fb_20)) or
((jed_node1) and (jed_node2)) or
((jed_node2) and not(jed_fb_20)));

jed_oept_23<=(one);

jed_sum_23<= (((jed_node1) and (jed_node2) and not(jed_node3)) or
((jed_node1) and not(jed_node2) and (jed_node3)) or
(not(jed_node1) and (jed_node3) and not(jed_fb_16)) or
(not(jed_node1) and not(jed_node3) and (jed_fb_16)));

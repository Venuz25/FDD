...
jed_sum_14<= (((jed_node2) and (jed_node3) and (jed_node4) and (jed_node5)
) or
...
((jed_node2) and not(jed_node5) and not(jed_fb_16)) or
(not(jed_node2) and not(jed_node5) and (jed_fb_16)));
...
((jed_node1) and not(jed_fb_20) and not(jed_node5)) or
(not(jed_node1) and (jed_fb_20) and not(jed_node5)));

jed_oept_16<=(one);

jed_sum_16<= (((jed_node5) and (jed_fb_16)) or
((jed_node1) and not(jed_node5)));

jed_oept_17<=(one);

jed_sum_17<= (((jed_node5) and (jed_fb_17)) or
((jed_node3) and not(jed_node5)));

jed_oept_20<=(one);

jed_sum_20<= (((jed_fb_20) and (jed_node5)));

jed_oept_21<=(one);

jed_sum_21<= (((jed_fb_21) and (jed_node5)) or
((jed_node2) and not(jed_node5)));

jed_oept_22<=(one);

jed_sum_22<= ((not(jed_node4) and not(jed_node5) and (jed_fb_17)) or
((jed_node4) and (jed_node5)) or
((jed_node4) and not(jed_fb_17)));

jed_oept_23<=(one);

jed_sum_23<= (((jed_node3) and not(jed_fb_21) and not(jed_node5)) or
((jed_node3) and not(jed_node4) and (jed_node5)) or
(not(jed_node3) and (jed_node4) and (jed_node5)) or
(not(jed_node3) and (jed_fb_21) and not(jed_node5)));

...
--Attribute PIN_NUMBERS of b(3):SIGNAL is "0004";
...
--Attribute PIN_NUMBERS of sr(3):SIGNAL is "0014";

SIGNAL  jed_oept_15:std_logic:='0';
SIGNAL  jed_sum_15,jed_fb_15:std_logic:='0';
--Attribute PIN_NUMBERS of sr(1):SIGNAL is "0015";

SIGNAL  jed_oept_16:std_logic:='0';
SIGNAL ci_1:std_logic:='0';
SIGNAL  jed_sum_16,jed_fb_16:std_logic:='0';
--Attribute PIN_NUMBERS of jed_node16:SIGNAL is "0016";

SIGNAL  jed_oept_17:std_logic:='0';
SIGNAL  jed_sum_17,jed_fb_17:std_logic:='0';
--Attribute PIN_NUMBERS of sr(0):SIGNAL is "0017";
...
--Attribute PIN_NUMBERS of sr(2):SIGNAL is "0023";
...
jed_sum_14<= (((jed_node3) and (jed_fb_21) and (jed_node4) and not(jed_node7)
) or
...
jed_sum_16<= (((jed_node3) and (jed_fb_20) and not(jed_node5)) or
...
jed_sum_21<= ((not(jed_node1) and (jed_node3) and (jed_fb_16)) or
...
jed_sum_22<= (((jed_node3) and (jed_fb_21) and not(jed_node4)) or
...
jed_sum_23<= (((jed_node1) and not(jed_node2) and (jed_node3) and (jed_fb_16)
) or

...
--    VHDL File: BCD-Hex_Display.vhd

--    Date: Mon Dec 04 22:01:49 2023
...
ARCHITECTURE DSMB of dec is
	...
	signal jed_node1	: std_logic:='0' ; -- switch
...
--Attribute PIN_NUMBERS of switch:SIGNAL is "0001";
...
jed_sum_15<= (((jed_node2) and not(jed_node3) and (jed_node4) and not(jed_node5)
) or
(not(jed_node2) and (jed_node3) and not(jed_node4) and not(jed_node5)
) or
(not(jed_node2) and not(jed_node3) and not(jed_node4)
...
jed_sum_16<= ((not(jed_node2) and not(jed_node3) and (jed_node4) and not(jed_node5)
) or
(not(jed_node1) and (jed_node2) and (jed_node3)) or
(not(jed_node1) and (jed_node2) and (jed_node4)) or
((jed_node2) and (jed_node3) and (jed_node4)) or
((jed_node2) and (jed_node3) and not(jed_node5)));
...
jed_sum_21<= (((jed_node1) and (jed_node2) and (jed_node3)) or
...
jed_sum_22<= (((jed_node2) and (jed_node3) and not(jed_node4) and (jed_node5)
) or
...
jed_sum_23<= ((not(jed_node2) and (jed_node3) and not(jed_node4) and (jed_node5)
) or
(not(jed_node1) and (jed_node2) and (jed_node3)) or
(not(jed_node1) and (jed_node2) and (jed_node4)) or

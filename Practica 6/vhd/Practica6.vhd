...
(not(jed_node1) and not(jed_node2) and (jed_node4) and (jed_node5)
) or
...
jed_sum_17<= (((jed_node1) and (jed_node2) and (jed_node3) and (jed_node5)
) or
...
jed_sum_21<= ((not(jed_node2) and not(jed_node3) and (jed_node4) and (jed_node5)
) or
...
jed_sum_22<= (((jed_node1) and (jed_node2) and not(jed_node3) and not(jed_node4)
 and (jed_node5)) or
...
jed_sum_23<= (((jed_node2) and (jed_node3) and not(jed_node4) and (jed_node5)
) or
...
((jed_node1) and not(jed_node4) and not(jed_node5)) or
